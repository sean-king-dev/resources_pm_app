 ...
 class pChart
  {
   ...
   var $Errors         = NULL;
   var $ErrorFontName  = "charts/Fonts/pf_arma_five.ttf";
   var $ErrorFontSize  = 6;
           ...
           if ( $t % 2 == 1 && $LastX1 != -1)
            {
             ...
             $C_Graph = $this->AllocateColor($this->Picture,230,230,230);
     ...
     for ( $t=1; $t<=$MaxValue; $t++)
      {
       ...
       $this->drawFilledRoundedRectangle($X+$Positions[6]-2,$Y+$Positions[7]-1,$X+$Positions[2]+4,$Y+$Positions[3]+1,2,255,255,255);
