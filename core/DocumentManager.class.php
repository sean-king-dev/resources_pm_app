...
/*                                                              */
/*  Class: DocumentManager.class.php                            */
/*                                                              */
/*  Author: Philip Cole                                         */
/*  Date:   4th April 2008                                      */
/*                                                              */
/*  This is the core document manager class                     */
/*                                                              */
/* ************************************************************ */
/*  Revision History                                            */
/*                                                              */
...
class DocumentManager {
    ...
    // Protected Variables
    protected $documents;       // Array of all the current document information
    protected $documentLibrary; // The current library in question
 ...
 *   @returns
 */
    protected function getDocuments( $library="" ) {
        $library == "" ? $library = $this->documentLibrary : NULL;
    }
 ...
 */
    protected function uploadDocuments() {
        $f = new CriterionForm2();
        $output = $f->outputBasicAddForm( "documents" );
        print $output;
    }
